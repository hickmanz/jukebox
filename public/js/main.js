...
function getTrackDiv(data){
    ...
    return '<li class="track-row"><div class="add"><i class="icon-plus"></i></div><div class="preview"><i class="icon-headphones"></i></div><div class="title">' + data.name + '</div><div class="artist">' + artists + '</div><div class="album">' + data.album.name + '</div><div class="duration">' + duration + '</div><div class="popularity">' + data.popularity + '</div></li>';
}